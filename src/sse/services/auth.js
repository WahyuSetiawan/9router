 ...
 */
export async function getProviderCredentials(provider, excludeConnectionIds = null, model = null, options = {}, cachedConnections = null) {
  ...
  try {
    ...
    const connections = cachedConnections?.providerId === providerId
